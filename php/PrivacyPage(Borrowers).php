...
<body>
    ...
    <div class="content-container">
        <div class="faqs-container">
            <h2>LoanDaddy Privacy Policy</h2>

            <p>Welcome to LoanDaddy! We are committed to protecting the privacy of our users. This Data Privacy Policy outlines how we collect, use, disclose, and safeguard your personal information when you visit our website or use our services.</p>

            <h3>1. Information We Collect</h3>
            
            <h4>1.1 Personal Information</h4>
            <p>We may collect personal information that you voluntarily provide, such as your name, email address, phone number, and other details when you register, fill out forms, or interact with our website.</p>

            <h4>1.2 Automatically Collected Information</h4>
            <p>We may automatically collect certain information, such as your IP address, browser type, device information, and browsing patterns, using cookies and similar technologies.</p>
            ...
            <p>We may share your information with trusted third-party service providers who assist us in operating our website, conducting our business, or servicing you.</p>

            <h4>3.2 Legal Requirements</h4>
            <p>We may disclose your information if required by law or in response to a lawful request from authorities.</p>
